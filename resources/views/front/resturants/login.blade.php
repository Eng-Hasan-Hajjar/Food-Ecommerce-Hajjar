...
<section class="back-body">
    <div class="shadow register-seler register add_offer text-center">
        <form class="container" method="POST" action="{{route('R.login')}}">
            @csrf
            ...
            <div class="overflow-hidden">
                <div class="float-right"><a class="" href="{{route('resturant.register')}}">مستخدم جديد؟</a></div>
                <div class="float-left">
                </div>
            </div>
            <div class="form-group mt-4">
                <a class="btn btn-danger btn-block" href="{{route('resturant.register')}}">انشاء حساب جديد</a>
            </div>
        </form>
