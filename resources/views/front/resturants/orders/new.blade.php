                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col  col-md-4 col-6">
                                            <button onclick="event.preventDefault();
                                                document.getElementById('reject-form{{$order->id}}').submit();"
                                                    class="btn  btn-danger "><i class="fas fa-thumbs-down"></i> رفض
                                            </button>
                                            <form id="reject-form{{$order->id}}" action="{{ route('reject') }}"
                                                  method="POST" style="display: none;">
                                                @csrf
                                                <input type="hidden" name="order_id" value="{{$order->id}}">
                    ...
                    <div class=" cart">
                        <div class="row">
                            <div class="col col-sm-8 col-12 pr-sm-0">
                                <h3 class="text-left py-3 text-info "> لا يوجد طلبات جديدة </h3>
                            </div>
                        </div>
                    </div>
                    <!-- end card -->
